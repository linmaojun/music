...
<head>
    ...
    <link href="${ctx.contextPath}/static/css/bootstrap.min.css" type="text/css" rel="stylesheet">
    <link href="${ctx.contextPath}/static/css/style.css" type="text/css" rel="stylesheet">
    <link type="text/css" href="${ctx.contextPath}/static/css/nprogress.css" rel="stylesheet">
    <script src="${ctx.contextPath}/static/js/html5shiv.min.js" type="text/javascript"></script>
    <script src="${ctx.contextPath}/static/js/respond.min.js" type="text/javascript"></script>
    <script src="${ctx.contextPath}/static/js/selectivizr-min.js" type="text/javascript"></script>
    <link rel="apple-touch-icon-precomposed" href="${ctx.contextPath}/static/images/icon/icon.png">
...
<section class="container user-select">
    <header>
        <div class="hidden-xs header"><!--超小屏幕不显示-->
            <h1 class="logo">
                <a href="index.html" title="异清轩技术博客 - POWERED BY WY ALL RIGHTS RESERVED"></a>
            </h1>
            <ul class="nav hidden-xs-nav">
                ...
                <li>
                    <a href=""><span class="glyphicon glyphicon-erase"></span>网站前端</a>
                </li>
                <li>
                    <a href=""><span class="glyphicon glyphicon-inbox"></span>后端技术</a>
                </li>
                <li>
                    <a href=""><span class="glyphicon glyphicon-globe"></span>管理系统</a>
                </li>
                <li>
                    <a href="about.html"><span class="glyphicon glyphicon-user"></span>关于我们</a>
                </li>
                <li>
            ...
            <div class="feeds">
                ...
                <a class="feed feed-weixin" data-toggle="popover" data-trigger="hover" title="微信扫一扫" data-html="true" data-content="<img src='images/weixin.jpg' alt=''>" href="javascript:;" target="_blank">
                    <i></i>关注微信
                </a>
            </div>
            <div class="wall">
                <a href="readerWall.html" target="_blank">读者墙</a> | <a href="tags.html" target="_blank">标签云</a>
            </div>
        </div>
        <!--/超小屏幕不显示-->
        <div class="visible-xs header-xs"><!--超小屏幕可见-->
            <div class="navbar-header header-xs-logo">
                <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#header-xs-menu" aria-expanded="false" aria-controls="navbar">
                ...
                <div class="row">
                    <div class="news-list">
                        ...
                        <div class="news-info col-xs-7 col-sm-7 col-md-8">
                            <dl>
                                <dt>
                                    <a href="" target="_blank" > 异清轩技术博客正式上线！ </a>
                                </dt>
                                <dd>
                                    <span class="name">
                            ...
                            <div class="news_bot col-sm-7 col-md-8">
                                ...
                                <span class="look"> 共 <strong>2126</strong> 人围观，发现 <strong> 12 </strong> 个不明物体 </span> </div>
                        </div>
                    </div>
                    <div class="news-list">
                        <div class="news-img col-xs-5 col-sm-5 col-md-4">
            ...
            <ul>
                <li>
                    <a target="_blank" href="">
                        ...
                        <span class="text">异清轩技术博客的SHORTCUT和ICON图标 ...</span>
            ...
            <ul>
                <li data-toggle="tooltip" data-placement="top" title="站长的评论">
                    <a target="_blank" href="">
                        ...
                        <span class="text">
                            <strong>异清轩站长</strong>
                            (2015-10-18) 说：<br />欢迎来到异清轩技术博客，在这里可以看到网站前端和后端的技术等 ...
                        </span>
                    </a>
                </li>
    ...
    <!--/右侧>992px显示-->
    <footer class="footer">POWERED BY &copy;<a href="http://www.htmlsucai.com">异清轩 YLSAT.COM</a> ALL RIGHTS RESERVED &nbsp;&nbsp;&nbsp;<span><a href="http://www.htmlsucai.com" target="_blank">豫ICP备15026801号-1</a></span> <span style="display:none"><a href="">网站统计</a></span> </footer>
</section>
<div><a href="javascript:;" class="gotop" style="display:none;"></a></div>
<!--/返回顶部-->
<script src="${ctx.contextPath}/static/js/jquery-2.1.4.min.js" type="text/javascript"></script>
<script src="${ctx.contextPath}/static/js/nprogress.js" type="text/javascript" ></script>
<script src="${ctx.contextPath}/static/js/bootstrap.min.js" type="text/javascript"></script>
